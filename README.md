...
This repository summarizes the contents  and labs covered in 5 days of the [RTL Desing using Verilog with Sky130 Technology](https://www.vlsisystemdesign.com/rtl-design-using-verilog-with-sky130-technology/) workshop.

![2](https://user-images.githubusercontent.com/100422485/166287200-fbabadbe-0450-4b16-a5e7-749103f79077.png)
...
``` 
$ cd /home/anandita.pg21.ec![1](https://user-images.githubusercontent.com/100422485/166278745-8619216c-377c-403f-af80-6c050a89c2a3.png)
/
$ mkdir VLSI
```
![1](https://user-images.githubusercontent.com/100422485/166274923-4777baca-c96a-46f9-8c97-ecbdc3227354.png)
...
## 1.6 Iverilog Simulation of Multiplexer(MUX)
...
### 1.7.1 Yosys Synthesis Flow setup
...
### 1.7.2 Verifying the Synthesis output netlist:
...
Also lets see different flavours of same cell in the .lib file.
 ...
 We can find that different flavours of  "AND" gate has different size ,area, power consumption. Below details hsows the comparison between these different " AND " gates:
```
...
We have a RTL design where we have two sub modules, both instantiated inside top module. 

As per above RTL code we expect the netlist will consist of AND and OR gates from library. 
...
Let take below combinational circuit. From boolean algebra we know that the output of this should always be 1. 
...
### 2.3.1 Different Flop coding styles
